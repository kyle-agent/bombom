...
> **zip 스냅샷(git 이력 없음)으로 받은 경우** `git submodule …`이 안 되니 카탈로그를 직접 받으세요
> (핀 커밋 `bb6a9b1a70c88e7f1e52780d032f63abf0d5c705`):
> ```bash
> git clone https://github.com/netbox-community/devicetype-library.git vendor/devicetype-library
> git -C vendor/devicetype-library checkout bb6a9b1a70c88e7f1e52780d032f63abf0d5c705
> bombom catalog reindex
> ```
